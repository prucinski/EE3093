...
int main(){
	...
	//go back to the beginning of the file. Storing the initial position of the pointer
	//is unnecessary.
	...
	//Quite frankly, I am not sure why the fwhm explaination was so complicated in the paper.
